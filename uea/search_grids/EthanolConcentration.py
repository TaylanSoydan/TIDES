# 4 classes, seq_len=1751, 3 channels
# Long sequence — lean on encoder depth, keep batch moderate
NUM_EPOCHS = None
...
SPARSE_GRID = {
    ...
    "learn_lambda":         ("categorical", ["stable","exp"]),
    "bidir":                ("categorical", [True, False]),
    "encoder_depth":        ("categorical", [0,1,2]),
    "lambda_encoder_depth": ("categorical", [0,1,2]),
    "bc_rank":              ("categorical", [4, 8, 16, 32]),
